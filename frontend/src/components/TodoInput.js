...
export default function TodoInput() {
  ...
  return (
    ...
    <input onClick={(addToDo)} type='text' placeholder='Add a ToDo!' value={text} onChange={(e) => setText(e.target.value)} className='py-2 px-4 rounded shadow w-full bg-slate-400 placeholder-white text-white'/>
